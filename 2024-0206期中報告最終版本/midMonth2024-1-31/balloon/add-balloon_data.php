...
function uploadFile(){    //上傳圖片
  ...
  const sendForm = e => {
    ...
    if(id.value <=0) {
        ...
        id.nextElementSibling.innerHTML = "請輸入id";
        }else{
    ...
    if(type.value <=0) {
        ...
        type.nextElementSibling.innerHTML = "請輸入類型";
        }else{
          type.style.border = '1px solid  transparent';
          type.nextElementSibling.innerHTML="" ;}

          if(score.value <=0) {
        isPass = false;
        score.style.border = '1px solid red';
        score.nextElementSibling.innerHTML = "請輸入分數";
        }else{
        ...
        speed.nextElementSibling.innerHTML = "請輸入速度";
        }else if (speed.value > 0 && speed.value < 0.1) {
        isPass = false;
      speed.style.border = '1px solid red';
       speed.nextElementSibling.innerHTML = "無法設定此速度";
    }else{
          speed.style.border = '1px solid  transparent';
          speed.nextElementSibling.innerHTML="" ;}
